var _a;
/* empty css                         */import { createSSRApp, h as h$1 } from "vue";
import { createInertiaApp } from "@inertiajs/inertia-vue3";
import createServer from "@inertiajs/server";
import { createPinia } from "pinia";
import Quasar from "quasar/src/vue-plugin.js";
import quasarIconSet from "quasar/icon-set/svg-mdi-v6.mjs";
import { r as resolvePageComponent } from "./assets/laravel-vite-plugin.63b13aae.mjs";
...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => resolvePageComponent(`./Pages/${name}.vue`, /* @__PURE__ */ Object.assign({ "./Pages/Account.vue": () => import("./assets/Account.2a5dd4ae.mjs"), "./Pages/Auth/ConfirmPassword.vue": () => import("./assets/ConfirmPassword.6c54fd49.mjs"), "./Pages/Auth/ForgotPassword.vue": () => import("./assets/ForgotPassword.62a233a7.mjs"), "./Pages/Auth/Login.vue": () => import("./assets/Login.76df54bc.mjs"), "./Pages/Auth/Register.vue": () => import("./assets/Register.b16a07f7.mjs"), "./Pages/Auth/ResetPassword.vue": () => import("./assets/ResetPassword.6e2cec0f.mjs"), "./Pages/Auth/VerifyEmail.vue": () => import("./assets/VerifyEmail.16c16833.mjs"), "./Pages/Crypto/Buy.vue": () => import("./assets/Buy.4bb4dff5.mjs"), "./Pages/Dashboard.vue": () => import("./assets/Dashboard.a047bcb1.mjs"), "./Pages/Welcome.vue": () => import("./assets/Welcome.0a1e3f22.mjs"), "./Pages/WelcomeModal.vue": () => import("./assets/WelcomeModal.8baadf06.mjs"), "./Pages/WelcomeSlideOver.vue": () => import("./assets/WelcomeSlideOver.8236eff6.mjs") })),
    setup({ el, app, props, plugin }) {
      return createSSRApp({ render: () => h$1(app, props) }).use(I, {
        ...page.props.ziggy,
        location: new URL(page.props.ziggy.location)
      }).use(createPinia()).use(Quasar, {
        iconSet: quasarIconSet
      }).use(plugin).use(Notifications).use(modal, {
        resolve: (name) => resolvePageComponent(`./Pages/${name}.vue`, /* @__PURE__ */ Object.assign({ "./Pages/Account.vue": () => import("./assets/Account.2a5dd4ae.mjs"), "./Pages/Auth/ConfirmPassword.vue": () => import("./assets/ConfirmPassword.6c54fd49.mjs"), "./Pages/Auth/ForgotPassword.vue": () => import("./assets/ForgotPassword.62a233a7.mjs"), "./Pages/Auth/Login.vue": () => import("./assets/Login.76df54bc.mjs"), "./Pages/Auth/Register.vue": () => import("./assets/Register.b16a07f7.mjs"), "./Pages/Auth/ResetPassword.vue": () => import("./assets/ResetPassword.6e2cec0f.mjs"), "./Pages/Auth/VerifyEmail.vue": () => import("./assets/VerifyEmail.16c16833.mjs"), "./Pages/Crypto/Buy.vue": () => import("./assets/Buy.4bb4dff5.mjs"), "./Pages/Dashboard.vue": () => import("./assets/Dashboard.a047bcb1.mjs"), "./Pages/Welcome.vue": () => import("./assets/Welcome.0a1e3f22.mjs"), "./Pages/WelcomeModal.vue": () => import("./assets/WelcomeModal.8baadf06.mjs"), "./Pages/WelcomeSlideOver.vue": () => import("./assets/WelcomeSlideOver.8236eff6.mjs") }))
      }).mixin({
        methods: {
          route: window.route
